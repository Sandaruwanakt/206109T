...
if bmi < 18.5:
    print("It's important to maintain a healthy weight. Please consider consulting a healthcare professional.")
elif bmi >= 25:
    print("Consider maintaining a balanced diet and staying physically active for a healthier lifestyle.")
else:
